...
![Jiwon Baik](img/profile.jpg)


Contact Info {#contact}
--------------------------------------------------------------------------------

- <i class="fa fa-envelope"></i> jiwonbaik@ucsb.edu
- <i class="fa fa-github"></i> [github.com/JiwonBaik96](https://github.com/JiwonBaik96)
- <i class="fa fa-phone"></i> +1 805-895-5522
...
- Highly skilled in R, Bash, Python, LaTeX, ArcGIS Pro
