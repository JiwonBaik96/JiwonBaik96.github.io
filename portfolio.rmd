...
* 3D Map Features and Spatial Modeling
  ...
  - 1.2. lab project: Extracting indoor details from LIDAR
...
![3dmap](img/lidar/data.jpg)

![model](img/lidar/segmentation.jpg)

![result](img/lidar/3d.jpg)
...
- [moviestock website](https://moviestock.herokuapp.com/movies/){target="_blank"}: it takes awhile to load the homepage as using free hosting by Heroku.
...
<center>
```{r, echo=FALSE}
shiny::includeHTML("data/swain_solutions.html")
```
</center>
