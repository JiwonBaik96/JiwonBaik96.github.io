...
- <i class="fas fa-desktop"></i> Sourcecode: $ git clone https://git.heroku.com/moviestock.git

<center>
<video width="480" height="320" controls>
  <source src="data/moviestock.mp4" type="video/mp4">
</video>
</center>
...
<p style='margin-left:1em;margin-right:1em;'>
* The mock-up website build project got the first prize out of 100+ teams in Samsung Software Academy.
* Please note that it's built within a week from a blank HTML. 
* Whole project ideas came from me, not given.
* The Location tab as the Javascript Map API to find the nearest theaters and the real-time reservation info of the movies.
* The interactive UI on the map has more things to be considered rather than any UIs out of the map. The map bounds, pop-up location, and marker sizes based on the zoom level were carefully considered.
</p>
</span>
</div>


![](img/moviestock/map.PNG)
...
* Whole project was conducted in R.
...
<p style='margin-left:1em;margin-right:1em;'>
* This project is to apply various statistical methods to 2016 Presidential Election Data, in order to predict who would win the vote. Hillary or Trump.
* The project was coded in R.
* Decision Tree, Logistic Regression, Hierarchical Clustering methods were used.
* Maps were used to visualize the model results.
</p></span>
</div>
